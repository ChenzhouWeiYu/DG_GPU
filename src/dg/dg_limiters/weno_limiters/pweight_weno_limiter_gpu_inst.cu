// include/DG/DG_Limiters/PWeightWENOLimiterGPU.cu
#include "dg/dg_limiters/weno_limiters/pweight_weno_limiter_gpu.cuh"
#include "dg/dg_limiters/weno_limiters/pweight_weno_limiter_gpu_impl.cuh"


// 显式实例化
#define explict_template_instantiation(Order) \
template class PWeightWENOLimiterGPU<Order, typename AutoQuadSelector<Order, GaussLegendreTet::Auto>::type, typename AutoQuadSelector<Order, GaussLegendreTri::Auto>::type>;
