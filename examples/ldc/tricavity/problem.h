...
// 顶盖速度
constexpr Scalar param_U_0 = 2.0;
// 马赫数 << 0.1 就行
...
// 雷诺数
constexpr Scalar param_Re = 400.0;
// 参考粘度
constexpr Scalar param_mu = param_rho_0 * param_U_0 * 2.0 / param_Re;
...
Type u_xyz(Type x, Type y, Type z, Type t){
    return (y>0-1e-12) ? param_U_0 : 0.0;
}
