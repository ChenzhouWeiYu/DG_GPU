...
class WENOLimiterGPU {
public:
    using Basis = DGBasisEvaluator<Order>;
    static constexpr uInt NumBasis = Basis::NumBasis;

    WENOLimiterGPU(const DeviceMesh& device_mesh)
        : mesh_(device_mesh)
    {}
...
extern template class WENOLimiterGPU<Order, typename AutoQuadSelector<Order, GaussLegendreTet::Auto>::type, typename AutoQuadSelector<Order, GaussLegendreTri::Auto>::type>;
