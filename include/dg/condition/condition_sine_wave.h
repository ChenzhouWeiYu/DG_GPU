...
template<typename Physics>
class ToroCondition : public ConditionInterface<ToroCondition<Physics>, Physics> {
public:
    using Base = ConditionInterface<ToroCondition<Physics>, Physics>;
    using Base::Base;       // 构造函数
    using Base::computeRho;
    using Base::computeU;
    using Base::computeV;
